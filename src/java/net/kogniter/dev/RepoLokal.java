...
class RepoLokal {
    ...
    InputStream buka(String namaBerkas) throws Exception {
        android.util.Log.d("Kogniter.RepoLokal", "buka repo_lokal: " + namaBerkas);
    ...
    private InputStream _bukaDariApk(String namaBerkas) throws Exception {
        android.util.Log.d("Kogniter.RepoLokal", "buka repo_lokal dari APK: " + namaBerkas);
        int id;
    ...
    private InputStream _bukaDariInternal(String versiWebUnduhan, String namaBerkas) throws Exception {
        android.util.Log.d("Kogniter.RepoLokal", "buka repo_lokal dari INTERNAL: " + namaBerkas);
        ...
        android.util.Log.d("Kogniter.RepoLokal", "membuka berkas: " + berkas);
    ...
    static int derajatMayorVersiWebDiApkIni() {
        ...
        try {
            ...
            android.util.Log.e("Kogniter.RepoLokal", "gagal cek versi mayor: " + e.getMessage());
            throw e;
        }
    }
    ...
    static int derajatMinorVersiWebDiApkIni() {
        ...
        try {
            ...
            android.util.Log.e("Kogniter.RepoLokal", "gagal cek versi minor: " + e.getMessage());
            throw e;
        }
    }
